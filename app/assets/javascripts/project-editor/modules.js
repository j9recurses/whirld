...
ModuleHtml.prototype = {
  ...
  comparison: function(){
    var html = "<article class='comparison-module module uk-width-1-1'>" + this.htmlHeader() + this.htmlDropzone() + "<div class='uk-form width-1-1'>" + this.htmlTaginput() + this.htmlCaption() + "</div></article>";
    return $(html);
  },
  grid: function(){
