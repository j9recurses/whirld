...
FilterBar.prototype = {
	...
	htmlRow: function(i){
		return $("<div id='row-" + i + "' class='row group wrapper></div>");
	},
	...
	appendResults: function(thumb){
		// self.searchResultsContainer
